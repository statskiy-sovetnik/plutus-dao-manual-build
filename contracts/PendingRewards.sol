...
contract PendingRewards is IPendingRewards {
  ...
  address private constant JONES_STAKER = 0x668BB973c3e35759269DAc6D5BF118EA9729110E; // @audit-ok актуальный адрес
  ...
  IDpxStakingRewards private constant DPX_STAKING_REWARDS =
    IDpxStakingRewards(0xc6D714170fE766691670f12c2b45C1f34405AAb6); // @note это похоже старый адрес,хз. Там вижу только exit и withdraw и очень давно
